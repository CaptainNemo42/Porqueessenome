...
class QuizzTipo extends StatefulWidget {
  const QuizzTipo({super.key});

  @override
  State<QuizzTipo> createState() => _QuizzTipoState();
}

class _QuizzTipoState extends State<QuizzTipo> {
  @override
