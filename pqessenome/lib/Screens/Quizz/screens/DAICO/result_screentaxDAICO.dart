...
import 'package:pqessenome/Screens/Quizz/screens/DAICO/models/questionstaxDAICO.dart';
import 'package:tutorial_coach_mark/tutorial_coach_mark.dart';

class ResultScreenTaxDAICO extends StatefulWidget {
  const ResultScreenTaxDAICO({
    super.key,
  ...
  @override
  State<ResultScreenTaxDAICO> createState() => _ResultScreenTaxDAICOState();
}

class _ResultScreenTaxDAICOState extends State<ResultScreenTaxDAICO> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          '${(widget.scoreTaxDAICO / questions.length * 100).round()}%',
                          style: const TextStyle(
                            fontFamily: 'Montserrat',
                            fontWeight: FontWeight.bold,
                            color: Color.fromRGBO(50, 50, 50, 1),
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => EstrelasDAICO(
                                      scoreLexDAICO: widget.scoreLexDAICO,
                                      scoreTaxDAICO: widget.scoreTaxDAICO,
                                      scoreTopDAICO: widget.scoreTopDAICO,
                                    )));
                      },
