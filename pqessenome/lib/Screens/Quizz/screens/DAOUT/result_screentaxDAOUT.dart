...
class ResultScreenTaxDAOUT extends StatefulWidget {
  const ResultScreenTaxDAOUT({
    super.key,
  ...
  @override
  State<ResultScreenTaxDAOUT> createState() => _ResultScreenTaxDAOUTState();
}

class _ResultScreenTaxDAOUTState extends State<ResultScreenTaxDAOUT> {
