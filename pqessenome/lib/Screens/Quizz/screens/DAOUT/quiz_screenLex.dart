...
import 'package:pqessenome/Screens/Quizz/screens/DAOUT/result_screenlexDAOUT.dart';
...
class QuizLexScreenDAOUT extends StatefulWidget {
  const QuizLexScreenDAOUT({super.key});

  @override
  State<QuizLexScreenDAOUT> createState() => _QuizLexScreenDAOUTState();
}
                ...
                ? RectangularButton(
                    onPressed: () {
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder: (_) => ResultScreenLexDAOUT(
