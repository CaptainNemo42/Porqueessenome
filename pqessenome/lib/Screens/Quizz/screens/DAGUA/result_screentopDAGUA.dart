...
class ResultScreenTopDAGUA extends StatefulWidget {
  ...
  @override
  State<ResultScreenTopDAGUA> createState() => _ResultScreenTopDAGUAState();
}

class _ResultScreenTopDAGUAState extends State<ResultScreenTopDAGUA> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          '${(widget.scoreTopDAGUA / questions.length * 100).round()}%',
                          style: const TextStyle(
                            fontFamily: 'Montserrat',
                            fontWeight: FontWeight.bold,
                            color: Color.fromRGBO(50, 50, 50, 1),
