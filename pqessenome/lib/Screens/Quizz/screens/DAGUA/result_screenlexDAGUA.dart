...
class ResultScreenLexDAGUA extends StatefulWidget {
  const ResultScreenLexDAGUA({
    super.key,
  ...
  @override
  State<ResultScreenLexDAGUA> createState() => _ResultScreenLexDAGUAState();
}

class _ResultScreenLexDAGUAState extends State<ResultScreenLexDAGUA> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          '${(widget.scoreLexDAGUA / questions.length * 100).round()}%',
                          style: const TextStyle(
                            fontFamily: 'Montserrat',
                            fontWeight: FontWeight.bold,
                            color: Color.fromRGBO(50, 50, 50, 1),
