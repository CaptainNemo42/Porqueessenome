...
class ResultScreenTaxDABEN extends StatefulWidget {
  const ResultScreenTaxDABEN({
    super.key,
  ...
  @override
  State<ResultScreenTaxDABEN> createState() => _ResultScreenTaxDABENState();
}

class _ResultScreenTaxDABENState extends State<ResultScreenTaxDABEN> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          '${(widget.scoreTaxDABEN / questions.length * 100).round()}%',
                          style: const TextStyle(
                            fontFamily: 'Montserrat',
                            fontWeight: FontWeight.bold,
                            color: Color.fromRGBO(50, 50, 50, 1),
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => EstrelasDABEN(
                                      scoreLexDABEN: widget.scoreLexDABEN,
                                      scoreTaxDABEN: widget.scoreTaxDABEN,
                                      scoreTopDABEN: widget.scoreTopDABEN,
                                    )));
                      },
