...
class ResultScreenTopDABEN extends StatefulWidget {
  const ResultScreenTopDABEN({
    super.key,
  ...
  @override
  State<ResultScreenTopDABEN> createState() => _ResultScreenTopDABENState();
}

class _ResultScreenTopDABENState extends State<ResultScreenTopDABEN> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          '${(widget.scoreTopDABEN / questions.length * 100).round()}%',
                          style: const TextStyle(
                            fontFamily: 'Montserrat',
                            fontWeight: FontWeight.bold,
                            color: Color.fromRGBO(50, 50, 50, 1),
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => EstrelasDABEN(
                                      ...
                                      scoreTaxDABEN: widget.scoreTopDABEN,
