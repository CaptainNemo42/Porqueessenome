...
class ResultScreenTopDASAC extends StatefulWidget {
  const ResultScreenTopDASAC({
    super.key,
  ...
  @override
  State<ResultScreenTopDASAC> createState() => _ResultScreenTopDASACState();
}

class _ResultScreenTopDASACState extends State<ResultScreenTopDASAC> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          '${(widget.scoreTopDASAC / questions.length * 100).round()}%',
                          style: const TextStyle(
                            fontFamily: 'Montserrat',
                            fontWeight: FontWeight.bold,
                            color: Color.fromRGBO(50, 50, 50, 1),
