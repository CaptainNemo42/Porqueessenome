...
class ResultScreenTaxDASAC extends StatefulWidget {
  const ResultScreenTaxDASAC({
    super.key,
  ...
  @override
  State<ResultScreenTaxDASAC> createState() => _ResultScreenTaxDASACState();
}

class _ResultScreenTaxDASACState extends State<ResultScreenTaxDASAC> {
