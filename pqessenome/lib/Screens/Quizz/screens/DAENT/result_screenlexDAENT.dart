...
class ResultScreenLexDAENT extends StatefulWidget {
  ...
  @override
  State<ResultScreenLexDAENT> createState() => _ResultScreenLexDAENTState();
}

class _ResultScreenLexDAENTState extends State<ResultScreenLexDAENT> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          '${(widget.scoreLexDAENT / questions.length * 100).round()}%',
                          style: const TextStyle(
                            fontFamily: 'Montserrat',
                            fontWeight: FontWeight.bold,
                            color: Color.fromRGBO(50, 50, 50, 1),
