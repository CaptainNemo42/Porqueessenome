...
import 'package:pqessenome/Screens/Quizz/screens/DAENT/result_screenDAENT.dart';
...
class QuizLexScreenDAENT extends StatefulWidget {
  const QuizLexScreenDAENT({super.key});

  @override
  State<QuizLexScreenDAENT> createState() => _QuizLexScreenDAENTState();
}

class _QuizLexScreenDAENTState extends State<QuizLexScreenDAENT> {
