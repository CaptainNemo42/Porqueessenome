...
class ResultScreenLexDABEL extends StatefulWidget {
  const ResultScreenLexDABEL({
    super.key,
  ...
  @override
  State<ResultScreenLexDABEL> createState() => _ResultScreenLexDABELState();
}

class _ResultScreenLexDABELState extends State<ResultScreenLexDABEL> {
