...
class ResultScreenTaxDABEL extends StatefulWidget {
  const ResultScreenTaxDABEL({
    super.key,
  ...
  @override
  State<ResultScreenTaxDABEL> createState() => _ResultScreenTaxDABELState();
}

class _ResultScreenTaxDABELState extends State<ResultScreenTaxDABEL> {
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => EstrelasDABEL(
                                      scoreLexDABEL: widget.scoreLexDABEL,
                                      scoreTaxDABEL: widget.scoreTaxDABEL,
                                      scoreTopDABEL: widget.scoreTopDABEL,
                                    )));
                      },
