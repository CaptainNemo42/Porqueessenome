...
class ResultScreenTopDABEL extends StatefulWidget {
  ...
  @override
  State<ResultScreenTopDABEL> createState() => _ResultScreenTopDABELState();
}

class _ResultScreenTopDABELState extends State<ResultScreenTopDABEL> {
