...
class BatistaCampos extends StatefulWidget {
  const BatistaCampos({super.key});

  @override
  State<BatistaCampos> createState() => _BatistaCamposState();
}

class _BatistaCamposState extends State<BatistaCampos> {
  @override
