...
class LDagua2 extends StatefulWidget {
  const LDagua2({super.key});

  @override
  State<LDagua2> createState() => _LDagua2State();
}

class _LDagua2State extends State<LDagua2> {
  @override
                ...
                child: TextButton.icon(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Terrafirme()));
                    },
                    icon: const Icon(Icons.library_books,
                        color: Color.fromRGBO(50, 50, 50, 1)),
                    style: TextButton.styleFrom(
