...
class Zonarural extends StatefulWidget {
  const Zonarural({super.key});

  @override
  State<Zonarural> createState() => _ZonaruralState();
}

class _ZonaruralState extends State<Zonarural> {
  @override
