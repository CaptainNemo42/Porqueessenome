...
import 'package:pqessenome/Screens/Distritos/Lexicografias/DAMOS/LDAMOS2.dart';
import 'package:pqessenome/Screens/Distritos/Lexicografias/DAMOS/LDAMOS4.dart';

class LDamos3 extends StatefulWidget {
  const LDamos3({super.key});

  @override
  State<LDamos3> createState() => _LDamos3State();
}

class _LDamos3State extends State<LDamos3> {
  @override
                ...
                child: TextButton.icon(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Saofrancisco()));
                    },
                ...
                child: TextButton.icon(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Carananduba()));
                    },
                    icon: const Icon(Icons.library_books,
                        color: Color.fromRGBO(50, 50, 50, 1)),
                    style: TextButton.styleFrom(
                ...
                child: TextButton.icon(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const Marau()));
                  },
                  icon: const Icon(Icons.library_books,
                      color: Color.fromRGBO(50, 50, 50, 1)),
                  style: TextButton.styleFrom(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Image(
                      image: AssetImage("assets/Components/Component 22.png"),
                      height: 91.0,
                      width: 90.0,
                    ),
                    const SizedBox(width: 10),
