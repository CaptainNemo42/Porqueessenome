...
class LDamos6 extends StatefulWidget {
  const LDamos6({super.key});

  @override
  State<LDamos6> createState() => _LDamos6State();
}

class _LDamos6State extends State<LDamos6> {
  @override
                ...
                child: TextButton.icon(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Zonarural()));
                    },
