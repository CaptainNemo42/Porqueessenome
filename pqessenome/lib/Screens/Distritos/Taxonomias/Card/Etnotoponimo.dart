...
class Etnotoponimo extends StatefulWidget {
  const Etnotoponimo({super.key});

  @override
  State<Etnotoponimo> createState() => _EtnotoponimoState();
}

class _EtnotoponimoState extends State<Etnotoponimo> {
  @override
