...
class TReduto extends StatefulWidget {
  const TReduto({super.key});

  @override
  State<TReduto> createState() => _TRedutoState();
}

class _TRedutoState extends State<TReduto> {
  @override
