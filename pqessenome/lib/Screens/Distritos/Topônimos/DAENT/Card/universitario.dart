...
class TUniversitario extends StatefulWidget {
  const TUniversitario({super.key});

  @override
  State<TUniversitario> createState() => _TUniversitarioState();
}

class _TUniversitarioState extends State<TUniversitario> {
  @override
