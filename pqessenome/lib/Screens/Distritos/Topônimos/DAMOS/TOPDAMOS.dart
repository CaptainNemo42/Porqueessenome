...
import 'package:pqessenome/Screens/Distritos/Top%C3%B4nimos/DAMOS/Card/farol.dart';
...
class TOPDamos extends StatefulWidget {
  ...
  @override
  State<TOPDamos> createState() => _TOPDamosState();
}

class _TOPDamosState extends State<TOPDamos> {
  @override
                ...
                child: TextButton.icon(
                    onPressed: () {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Tpraiagrande()));
                    },
                    icon: const Icon(Icons.library_books,
                        color: Color.fromRGBO(50, 50, 50, 1)),
                    style: TextButton.styleFrom(
