...
class TFarol extends StatefulWidget {
  const TFarol({super.key});

  @override
  State<TFarol> createState() => _TFarolState();
}

class _TFarolState extends State<TFarol> {
  @override
