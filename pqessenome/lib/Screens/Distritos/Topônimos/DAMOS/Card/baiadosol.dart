...
class TBaiadosol extends StatefulWidget {
  const TBaiadosol({super.key});

  @override
  State<TBaiadosol> createState() => _TBaiadosolState();
}

class _TBaiadosolState extends State<TBaiadosol> {
  @override
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child:
              ...
              const Text("Topônimo: Baía do sol",
                  style: TextStyle(
                    fontFamily: "Light",
                    color: Color.fromRGBO(50, 50, 50, 1),
                    fontSize: 20.0,
