...
class TAeroporto extends StatefulWidget {
  const TAeroporto({super.key});

  @override
  State<TAeroporto> createState() => _TAeroportoState();
}

class _TAeroportoState extends State<TAeroporto> {
  @override
